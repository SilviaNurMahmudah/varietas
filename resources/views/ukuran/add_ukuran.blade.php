        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <div id="main">
                <div class="container-fluid">
                  <form class="form-horizontal" action="/create-ukuran" method="post">
                    @csrf
                    <div class="box-body">
                      <div class="row">
                        <div class="form-group col-md-6 col-xs-12">
                          <label for="inputName">Ukuran Buah</label>
                          <input type="text" class="form-control" required="required" name="ukuran" placeholder="Masukkan ukuran buah"></br>
                        </div>
                      </div>
